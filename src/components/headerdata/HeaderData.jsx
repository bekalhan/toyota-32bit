  ...
  return (
    <Grid container>
      ...
      <Grid item lg={name==="error" ? 2.8 : 2.2} md={2.8} sm={12} xs={12} sx={{display:'flex',justifyContent:'flex-start'}}>
        <Typography sx={{fontSize:{lg:'22px',md:'18px',sm:'20px'},fontWeight:'bold',color:'#847f18',marginTop:{lg:'0.2em',md:'0.4em',sm:'0.4em',xs:'0.5em'},marginLeft:{lg:'0.4em'}}}>{t('hatagirisekrani')}</Typography>
      </Grid>
